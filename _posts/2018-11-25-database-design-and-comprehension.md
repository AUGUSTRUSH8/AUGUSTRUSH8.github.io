...
![1526085541996](http://image.augustrush8.com/images/databaseDesign/1526085541996.png){:.center}
...
似乎并不复杂，但是大家仔细思考一下，商品的规格字段你如何填写？
 ...
 ![1526086539789](http://image.augustrush8.com/images/databaseDesign/1526086539789.png){:.center}
...
> 华为的规格：
 ...
 ![1526087063700](http://image.augustrush8.com/images/databaseDesign/1526087063700.png){:.center}



> 三星的规格：

 ![1526087142454](http://image.augustrush8.com/images/databaseDesign/1526087142454.png){:.center}
...
如下图所示：
 ...
 ![1526088168565](http://image.augustrush8.com/images/databaseDesign/1526088168565.png){:.center}
...
![1526088981953](http://image.augustrush8.com/images/databaseDesign/1526088981953.png){:.center}
...
![1526089506566](http://image.augustrush8.com/images/databaseDesign/1526089506566.png){:.center}
...
![1526090072535](http://image.augustrush8.com/images/databaseDesign/1526090072535.png){:.center}

你会发现，过滤条件中的屏幕尺寸、运行内存、网路、机身内存、电池容量、CPU核数等，在规格参数中都能找到：

 ![1526090228171](http://image.augustrush8.com/images/databaseDesign/1526090228171.png){:.center}
...
也就是说，规格参数中的数据，将来会有一部分作为搜索条件来使用。我们可以在设计时，将这部分属性标记出来，将来做搜索的时候，作为过滤条件。要注意的是，无论是SPU的全局属性，还是SKU的特有属性，都有可能作为搜索过滤条件的，并不冲突，而是有一个交集：
 ...
 ![1526091216124](http://image.augustrush8.com/images/databaseDesign/1526091216124.png){:.center}
...
![1526092179381](http://image.augustrush8.com/images/databaseDesign/1526092179381.png){:.center}
...
> 先整体看一下：
 ...
 ![1526092693138](http://image.augustrush8.com/images/databaseDesign/1526092693138.png){:.center}
...
> 接下来是params：
 ...
 ![1526093111370](http://image.augustrush8.com/images/databaseDesign/1526093111370.png){:.center}
...
上面的截图中所有属性都是全局属性，我们来看看内存，应该是特有属性：
  ...
  ![1526262641446](http://image.augustrush8.com/images/databaseDesign/1526262641446.png){:.center}
...
> 整体来看：
 ...
 ![1526262279963](http://image.augustrush8.com/images/databaseDesign/1526262279963.png){:.center}

整体看上去与规格参数表中的数据一样，也是一个数组，并且分组，每组下有多个参数

> 展开一组来看

 ![1526262389233](http://image.augustrush8.com/images/databaseDesign/1526262389233.png){:.center}
...
刚才看到的是全局属性，那么特有属性在这个字段中如何存储呢？
 ...
 ![1526263214087](http://image.augustrush8.com/images/databaseDesign/1526263214087.png){:.center}
...
在哪里会用到这个字段的值呢，商品详情页的规格参数信息中：
 ...
 ![1526267700765](http://image.augustrush8.com/images/databaseDesign/1526267700765.png){:.center}
...
来看数据格式：
 ...
 ![1526267952827](http://image.augustrush8.com/images/databaseDesign/1526267952827.png){:.center}
...
比如，商品详情页展示可选的规格参数时：
   ...
   ![1526267828817](http://image.augustrush8.com/images/databaseDesign/1526267828817.png){:.center}
...
既然如此，我们是不是可以将不同角标串联起来，作为SPU下不同SKU的标示。这就是我们的indexes字段。
 ...
 ![1526266901335](http://image.augustrush8.com/images/databaseDesign/1526266901335.png){:.center}

这个设计在商品详情页会特别有用：

 ![1526267180997](http://image.augustrush8.com/images/databaseDesign/1526267180997.png){:.center}
